...
/**
 * Validates 0220/0221 ATM Financial Transaction Advice Request
 * 
 * @author ztorres
 *
 */
public class ValidateATMFinancialTxAdviceParticipant 
	...
	public void commit(long id, Serializable context)
	{
        ...
        try 
        {
        	...
        	if (StringUtils.isEmpty(message))
        	{
        		...
        		{
        			throw new Exception(ValidateRequest.ErrorMsg.INVALID_LENGTH + " for Secodary Bit Map");
        		}
        	...
        	if (StringUtils.isEmpty(message))
        	{
        		...
        		{
        			throw new Exception(ValidateRequest.ErrorMsg.INVALID_LENGTH + " for Transaction Date and Time");
        		}
        		if (!StringUtils.isNumeric(message))
        		{
        			throw new Exception(ValidateRequest.ErrorMsg.INVALID_NUMERIC + " for Transaction Date and Time");
        		}
        	}
        	...
        	if (StringUtils.isEmpty(message))
        	{
        		...
        		{
        			throw new Exception(ValidateRequest.ErrorMsg.INVALID_LENGTH + " for Acquiring Institution ID Code");
        		}
        		if (!StringUtils.isNumeric(message))
        		{
        			throw new Exception(ValidateRequest.ErrorMsg.INVALID_NUMERIC + " for Acquiring Institution ID Cod");
        		}
        	}
        	...
        	if (StringUtils.isEmpty(message))
        	{
        		if (message.length() != 6)
        		{
        			throw new Exception(ValidateRequest.ErrorMsg.INVALID_LENGTH + " for Authorization ID Response");
        		}
        		if (!StringUtils.isAlphanumeric(message))
        		{
        			throw new Exception(ValidateRequest.ErrorMsg.INVALID_ALPHA_NUMERIC + " for Authorization ID Response");
        		}
        	}
        	...
        	if (StringUtils.isEmpty(message))
        	{
        		if (message.length() != 16)
        		{
        			throw new Exception(ValidateRequest.ErrorMsg.INVALID_LENGTH + " for Card Issuer and Authorization Data");
        		}
        		if (!ValidateRequestHelper.isRegexMatch(message, ValidateRequest.RegEx.ALPHA_NUMERIC_SPECIAL_CHAR))
        		{
        			throw new Exception(ValidateRequest.ErrorMsg.INVALID_ALPHA_NUMERIC_SPECIAL_CHARS + " for Card Issuer and Authorization Data");
        		}
        	}
        	...
        	if (StringUtils.isEmpty(message))
        	{
        		...
        		{
        			throw new Exception(ValidateRequest.ErrorMsg.INVALID_LENGTH + " for User Data");
        		}
        		if (!StringUtils.isAlphanumeric(message))
        		{
        			throw new Exception(ValidateRequest.ErrorMsg.INVALID_ALPHA_NUMERIC + " for User Data");
        		}
        	}
