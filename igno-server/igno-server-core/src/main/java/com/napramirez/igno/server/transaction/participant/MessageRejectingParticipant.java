...
/**
 * MessageRejectingParticipant echoes the request to the client, turning it to a 9xxx message in the process. TODO: Fix
 * client in order to handle 9xxx, as it expects only valid responses.
 * 
